...
if __name__ == "__main__":
    ...
    for m in mode:
        if m == "argmax":
            if args.no_cuda:
                subprocess.call(["python", "./evaluate_qa_gpt.py","--model_name",args.model_file,"--no_cuda","--eval_dataset",args.data_file,"--do_eval","--output_dir","./eval_2/"+args.output_dir+"/test"+args.version+"/argmax","--eval_batch_size","1", "--argmax"])
        ...
        if m == "normal":
            if args.no_cuda:
                subprocess.call(["python", "./evaluate_qa_gpt.py","--model_name",args.model_file,"--no_cuda","--eval_dataset",args.data_file,"--do_eval","--output_dir","./eval_2/"+args.output_dir+"/test"+args.version+"/normal","--eval_batch_size","1", "--sample","1",])
        ...
        if m == "sample10":
            if args.no_cuda:
                subprocess.call(["python", "./evaluate_qa_gpt.py","--model_name",args.model_file,"--no_cuda","--eval_dataset",args.data_file,"--do_eval","--output_dir","./eval_2/"+args.output_dir+"/test"+args.version+"/sample10","--eval_batch_size","1", "--sample","10",])
